  ...
  return (
    <>
      ...
      <div className="text-center md:text-left">
         <h1 className="text-4xl font-black text-gray-800 dark:text-white tracking-tight">Your Wallet</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch">
        ...
        <div className="relative h-72 bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:from-slate-800 dark:via-slate-900 dark:to-black rounded-[2.5rem] shadow-2xl p-10 text-white overflow-hidden flex flex-col justify-between group transform transition-transform hover:scale-[1.01]">
          {/* Card Decorations */}
        ...
        {/* Calculator */}
        <div className="glass-card dark:glass-card p-10 rounded-[2.5rem] h-full flex flex-col justify-center">
          <h3 className="font-bold text-xl text-gray-700 dark:text-gray-200 mb-8 flex items-center">
            ...
            <div>
              ...
              <div className="relative">
                 <input 
                  ...
                  className="w-full p-5 pl-6 border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 rounded-2xl font-mono text-2xl outline-none focus:ring-4 focus:ring-india-blue/10 dark:focus:ring-blue-900/30 focus:border-india-blue/50 dark:focus:border-blue-500/50 transition-all shadow-sm text-gray-800 dark:text-white"
                />
      ...
      {/* Redeem Section */}
      <div className="glass-card dark:glass-card p-12 rounded-[3rem] text-center relative overflow-hidden border-t-4 border-india-saffron">
